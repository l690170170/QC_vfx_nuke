...
def platform_pref_path():
    ...
    if platform.system() == "Windows":
        pref_path = "C:/Users/%s/.nuke/pr_suite_preferences.py" % current_user
        return pref_path
    elif platform.system() == "Darwin":
        pref_path = "Users/%s/.nuke/pr_suite_preferences.py" % current_user
        return pref_path
    elif platform.system() == "Linux":
        pref_path = "/home/%s/.nuke/pr_suite_preferences.py" % current_user
        return pref_path
    else:
...
class PrSuitePreferencesPanel(nukescripts.PythonPanel):
    ...
    def __init__(self):
        ...
        """
        nukescripts.PythonPanel.__init__(self, "Pr_Suite Preferences", "com.parimalvfx.PrSuitePreferencesPanel")

        self.setMinimumSize(450, 700)

        self.PrPref = nuke.Text_Knob("pr_suite_pref", "", "<font color='grey' size='7'><b>Pr_</b>Suite Preferences"
                                                          "</font><br>")
    ...
    def knobChanged(self, knob):
        ...
        if knob.name() == "save_pref":
            try:
                ...
                save_pref.write("# Pr_Suite v1.1 Preferences")
                # Gizmo Color
