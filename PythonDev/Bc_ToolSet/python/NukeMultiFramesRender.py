...
if os.path.isfile(verFile):
    ...
    while len(allWrite) != 1:
        ...
        if allWrite[0]["use_limit"].value() is True:
            ...
            tempPath = "C:/Users/%s/AppData/Local/Temp/Bc_ToolSetTemp/" % userName
...
""" % (verFolder, verExe, chunkFirst, chunkLast, nukeFile)
    ...
    print "\nPlease generate a 'nuke.ver' file from Bc_ToolSet menu inside Nuke before using Bc_ToolSet Nuke Render."
